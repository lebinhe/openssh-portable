...
prefix=/Users/lebinhe/Project/github/openssh/V_7_5/dist
exec_prefix=${prefix}
...
CPPFLAGS=-I. -I$(srcdir) -I/usr/local/opt/openssl/include $(PATHS) -DHAVE_CONFIG_H
...
ENT=
XAUTH_PATH=/opt/X11/bin/xauth
LDFLAGS=-L. -Lopenbsd-compat/ -L/usr/local/opt/openssl/lib -fstack-protector-strong -pie
EXEEXT=
...
PATHSUBS	= \
	...
	-e 's|/usr/bin:/bin:/usr/sbin:/sbin|/usr/bin:/bin:/usr/sbin:/sbin:/Users/lebinhe/Project/github/openssh/V_7_5/dist/bin|g'
